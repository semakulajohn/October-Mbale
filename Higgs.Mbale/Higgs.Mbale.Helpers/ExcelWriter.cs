 ...
 public   class ExcelWriter
    {
        ...
        public byte[] GenerateExcelFile(ExcelData data)
        {
        ...
        public void GenerateExcel(ExcelData data, string excelFileFullPath)
        {
            var stream = new MemoryStream();

            var document = SpreadsheetDocument.Create(excelFileFullPath, SpreadsheetDocumentType.Workbook);
